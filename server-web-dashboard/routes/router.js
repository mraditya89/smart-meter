...
router.get(
  "/get-datalistrik-all/current-year/:id",
  DataListrikCtrl.getCurrentYearDataListrikById
);
router.get(
  "/get-datalistrik-all/current-year",
  DataListrikCtrl.getCurrentYearDataListrik
);
router.get(
  "/get-datalistrik-all/last-year",
  DataListrikCtrl.getLastYearDataListrik
);
router.post("/datalistrik", DataListrikCtrl.postDataListrik);

router.get("/get-transaksi", TransaksiCtrl.getTransaksiAll);
router.get("/get-transaksi/:id", TransaksiCtrl.getTransaksiUnit);
router.get(
  "/get-transaction-histories",
  TransactionHistoriesCtrl.getTransactionHistories
);
