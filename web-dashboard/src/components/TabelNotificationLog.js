...
export default function TabelNotificationLog(param) {
    ...
    <TableContainer component={Paper}>
        ...
        <TableHead>
            <TableRow>
                <TableCell align="center" style={{fontWeight: 'bold'}}>Waktu</TableCell>
                <TableCell align="center" style={{fontWeight: 'bold'}}>Notifikasi</TableCell>
                <TableCell align="center" style={{fontWeight: 'bold'}}>Pesan</TableCell>
            </TableRow>
        </TableHead>
        <TableBody>
            {(rowsPerPage > 0
