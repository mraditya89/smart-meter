          ...
          <Grid container spacing={3} alignItems={"center"}>
            <Grid item xs={12} md={3} lg={3}>
              <Paper className={fixedHeightPaper}>
                <CountPanel
                  title="Jumlah Unit Total"
                  jumlah={param.jumlah.total}
                />
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={3} lg={3}>
              <Paper className={fixedHeightPaper}>
                <CountPanel
                  title="Jumlah Unit Menyala"
                  jumlah={param.jumlah.on}
                />
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={3} lg={3}>
              <Paper className={fixedHeightPaper}>
                <CountPanel
                  title="Jumlah Unit Mati"
                  jumlah={param.jumlah.off}
                />
              </Paper>
            </Grid>
