...
function LastYearPageFunction(param) {
          ...
          <Grid container spacing={3} alignItems={'center'}>
            ...
            <Grid item xs={12} md={12} lg={12}>
              <Paper className={fixedHeightPaper2}>
                <Chart2 datas={param.datas} year={dt.getFullYear()-1}/>
              </Paper>
            </Grid>
...
export default class LastYearPage extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount = async () => {
    await api.getLastYear().then(res => {
      this.setState({
  ...
  render() {
    ...
    return (
      <LastYearPageFunction datas={this.state.data_all} />
    )
  }
}